...
// node_modules/react-simple-image-slider/dist/index.js
var require_dist = __commonJS({
  "node_modules/react-simple-image-slider/dist/index.js"(exports, module) {
    ...
    (function(ImageSliderNavStyle2) {
      ImageSliderNavStyle2[ImageSliderNavStyle2["NORMAL"] = 1] = "NORMAL";
      ImageSliderNavStyle2[ImageSliderNavStyle2["BOLD"] = 2] = "BOLD";
    })(ImageSliderNavStyle || (ImageSliderNavStyle = {}));
    var ImageSliderNavDirection;
    (function(ImageSliderNavDirection2) {
      ImageSliderNavDirection2["LEFT"] = "left";
      ImageSliderNavDirection2["RIGHT"] = "right";
    })(ImageSliderNavDirection || (ImageSliderNavDirection = {}));
    var altNavArrowLeft = "slide to left";
    var altNavArrowRight = "slide to right";
    var ImageSliderNavigation = function ImageSliderNavigation2(props) {
    ...
    var ImageSliderBullets = function ImageSliderBullets2(_ref) {
      var visible = _ref.visible, length = _ref.length, currentIdx = _ref.currentIdx, onClickBullets = _ref.onClickBullets;
    ...
    var useSlideIndex = function useSlideIndex2(_ref2) {
      var startIndex = _ref2.startIndex, imageCount = _ref2.imageCount, autoPlay = _ref2.autoPlay, autoPlayDelay = _ref2.autoPlayDelay;
      var _React$useState = React.useState(startIndex < imageCount ? startIndex : 0), _React$useState2 = _slicedToArray(_React$useState, 2), slideIdx = _React$useState2[0], setSlideIdx = _React$useState2[1];
      ...
      var setAutoPlayTimeout = function setAutoPlayTimeout2(idx) {
      ...
      var removeAutoPlayTimeout = function removeAutoPlayTimeout2() {
        if (autoPlayTimerRef.current !== null) {
          clearTimeout(autoPlayTimerRef.current);
          autoPlayTimerRef.current = null;
        }
      };
      var getNextLoopingIdx = function getNextLoopingIdx2(idx) {
        if (idx >= imageCount) {
          return 0;
        } else if (idx < 0) {
          return imageCount - 1;
      ...
      var updateSlideIdx = function updateSlideIdx2(idx) {
    ...
    var getURLValueFromImages = function getURLValueFromImages2(images, index) {
      var _images$index;
      return ((_images$index = images[index]) === null || _images$index === void 0 ? void 0 : _images$index.url) || images[index];
    };
    var SimpleImageSlider = function SimpleImageSlider2(_ref3) {
      var width = _ref3.width, height = _ref3.height, images = _ref3.images, showNavs = _ref3.showNavs, showBullets = _ref3.showBullets, _ref3$loop = _ref3.loop, loop = _ref3$loop === void 0 ? true : _ref3$loop, _ref3$autoPlay = _ref3.autoPlay, autoPlay = _ref3$autoPlay === void 0 ? false : _ref3$autoPlay, _ref3$autoPlayDelay = _ref3.autoPlayDelay, autoPlayDelay = _ref3$autoPlayDelay === void 0 ? 2 : _ref3$autoPlayDelay, _ref3$startIndex = _ref3.startIndex, startIndex = _ref3$startIndex === void 0 ? 0 : _ref3$startIndex, _ref3$style = _ref3.style, style = _ref3$style === void 0 ? void 0 : _ref3$style, _ref3$slideDuration = _ref3.slideDuration, slideDuration = _ref3$slideDuration === void 0 ? 0.5 : _ref3$slideDuration, _ref3$bgColor = _ref3.bgColor, bgColor = _ref3$bgColor === void 0 ? "#000" : _ref3$bgColor, _ref3$useGPURender = _ref3.useGPURender, useGPURender = _ref3$useGPURender === void 0 ? true : _ref3$useGPURender, _ref3$navSize = _ref3.navSize, navSize = _ref3$navSize === void 0 ? 50 : _ref3$navSize, _ref3$navMargin = _ref3.navMargin, navMargin = _ref3$navMargin === void 0 ? 30 : _ref3$navMargin, _ref3$navStyle = _ref3.navStyle, navStyle = _ref3$navStyle === void 0 ? ImageSliderNavStyle.NORMAL : _ref3$navStyle, _ref3$onClick = _ref3.onClick, onClick = _ref3$onClick === void 0 ? void 0 : _ref3$onClick, _ref3$onClickNav = _ref3.onClickNav, onClickNav = _ref3$onClickNav === void 0 ? void 0 : _ref3$onClickNav, _ref3$onClickBullets = _ref3.onClickBullets, onClickBullets = _ref3$onClickBullets === void 0 ? void 0 : _ref3$onClickBullets, _ref3$onStartSlide = _ref3.onStartSlide, onStartSlide = _ref3$onStartSlide === void 0 ? void 0 : _ref3$onStartSlide, _ref3$onCompleteSlide = _ref3.onCompleteSlide, onCompleteSlide = _ref3$onCompleteSlide === void 0 ? void 0 : _ref3$onCompleteSlide;
      ...
      }), slideIdx = _useSlideIndex.slideIdx, updateSlideIdx = _useSlideIndex.updateSlideIdx, isRightDirection = _useSlideIndex.isRightDirection, getNextLoopingIdx = _useSlideIndex.getNextLoopingIdx, previousSlideIdx = _useSlideIndex.previousSlideIdx;
      var _React$useState3 = React.useState(styles.getImageSlide(getURLValueFromImages(images, startIndex), slideDuration, 0, useGPURender)), _React$useState4 = _slicedToArray(_React$useState3, 2), currentSliderStyle = _React$useState4[0], setCurrentSlideStyle = _React$useState4[1];
      var _React$useState5 = React.useState(styles.getImageSlide(getURLValueFromImages(images, startIndex + 1), slideDuration, 1, useGPURender)), _React$useState6 = _slicedToArray(_React$useState5, 2), nextSliderStyle = _React$useState6[0], setNextSliderStyle = _React$useState6[1];
...
//# sourceMappingURL=react-simple-image-slider.js.map
